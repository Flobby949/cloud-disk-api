...
module.exports = app => {
  ...
  const User = app.model.define('user', {
    ...
    desc: { type: TEXT, allowNull: false, defaultValue: '', comment: '个性签名' },
    total_size: { type: INTEGER, defaultValue: 10485760, comment: '网盘总大小，单位:kb' },
    used_size: { type: INTEGER, defaultValue: 0, comment: '网盘已使用大小，单位:kb' },
    created_time: DATE,
    updated_time: DATE,
  });
  return User;
